...
type: inbox
added: 20260204
themes: [skill, agent, workflow, mcp]
source_type: document
url: ""
keywords: [skill, claude, anthropic, mcp, yaml, frontmatter, progressive-disclosure]
summary: "Claude向けSkillの構築・設計・テスト・配布に関する包括的ガイド。SKILL.mdの書き方、YAMLフロントマター、MCPとの連携パターン、トラブルシューティングまで網羅。"
